...
:::demo
```html
<by-pagination :total="60"></by-pagination>
```
:::
...
:::demo
```html
<by-pagination :total="100"></by-pagination>
```
:::
...
:::demo
```html
<by-pagination :total="80" show-total></by-pagination>
```
:::
...
:::demo
```html
<by-pagination :total="100" show-quickjump></by-pagination>
```
:::
...
:::demo
```html
<by-pagination :total="100" show-sizer></by-pagination>
```
:::
...
:::demo
```html
<by-pagination :total="100" show-total show-sizer show-quickjump></by-pagination>
```
:::
...
:::demo
```html
<by-pagination size="small" :total="100" show-total show-sizer show-quickjump></by-pagination>
```
:::
...
:::demo
```html
<by-pagination :total="100" simple></by-pagination>
<by-pagination :total="100" size="small" simple></by-pagination>
```
:::
