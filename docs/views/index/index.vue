<template>
    <div class="index">
        ...
        <div class="index-container">
            <span id="index-logo"
                  @click="replay"></span>
            <p class="desc" :class="{active:active}">{{$t('by.index.h4')}}</p>
            <by-button round
                       class="start-button"
        ...
        <div>
            <img src="../../assets/image/img45.png"
                 class="circleLeft" />
            <img src="../../assets/image/decor-home-page-right.png"
                 class="circleRight" />
        </div>
        <by-footer></by-footer>
    </div>
...
.index {
    ...
    .index-container {
        ...
        video {
            margin-top: 90px;
            width: 70%;
            box-shadow: 0 14px 24px 0 rgba(160, 161, 188, 0.4);
            border-radius: 12px;
            overflow: hidden;
        ...
        .separate-panel {
            ...
            &::before {
                ...
                height: 350px;
                background-color: #f8faff;
                box-shadow: 0 -4px 30px 0 #f8faff;
